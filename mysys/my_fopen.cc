...
FILE *my_fopen(const char *filename, int flags, myf MyFlags) {
  ...
  EasyLoggerWithTrace(log_path_mysys, EasyLogger::info).force_flush() << "my_fopen::fopen. create or open file:" << filename << ", fd:" << fd->_fileno;
...
#ifdef MULTI_MASTER_ZHANG_LOG
  EasyLoggerWithTrace(log_path_mysys, EasyLogger::info).force_flush() << "my_freopen::freopen. create or open file:" << path << ", fd:" << result->_fileno;
#endif // MULTI_MASTER_ZHANG_LOG
#endif
...
#ifdef MULTI_MASTER_ZHANG_LOG
  EasyLoggerWithTrace(log_path_mysys, EasyLogger::info).force_flush() << "my_fdopen::fdopen. open fd:" << fd;
#endif // MULTI_MASTER_ZHANG_LOG
#endif
  if (!fd) {
    set_my_errno(errno);
